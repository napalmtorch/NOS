...
void serial_printc_col(char c, uint8_t color)
{
    serial_setcol(color);
    serial_printc(c);
    serial_setcol(0xFF);
...
void serial_print_col(const char* str, uint8_t color)
{
    serial_setcol(color);
    serial_print(str);
    serial_setcol(0xFF);
...
void serial_println_col(const char* str, uint8_t color)
{
...
void serial_setcol(uint8_t color)
{
    ...
    switch (color)
    {
        case 0x0: { serial_print("\033[34");  break; }
        case 0x1: { serial_print("\033[34m"); break; }
        case 0x2: { serial_print("\033[32m"); break; }
        case 0x3: { serial_print("\033[36m"); break; }
        case 0x4: { serial_print("\033[31m"); break; }
        case 0x5: { serial_print("\033[35m"); break; }
        case 0x6: { serial_print("\033[33m"); break; }
        case 0x7: { serial_print("\033[37m"); break; }
        case 0x8: { serial_print("\033[37m"); break; }
        case 0x9: { serial_print("\033[34m"); break; }
        case 0xA: { serial_print("\033[32m"); break; }
        case 0xB: { serial_print("\033[36m"); break; }
        case 0xC: { serial_print("\033[31m"); break; }
        case 0xD: { serial_print("\033[35m"); break; }
        case 0xE: { serial_print("\033[33m"); break; }
        case 0xF: { serial_print("\033[37m"); break; }
        default:  { serial_print("\033[0m");  break; }
    }
}
